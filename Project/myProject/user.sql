SET NAMES UTF8;
DROP DATABASE IF EXISTS yams;
CREATE DATABASE yams CHARSET=UTF8;
USE yams;

/*******用户表*********/
CREATE TABLE yams_user(
  uid INT PRIMARY KEY AUTO_INCREMENT,
  uname VARCHAR(64) NOT NULL,
  uimg	VARCHAR(64) NOT NULL
);
/****首页轮播广告商品****/
CREATE TABLE yam_index_carousel(
  cid INT PRIMARY KEY AUTO_INCREMENT,
  img VARCHAR(128),
  title VARCHAR(64)
);
/****首页商品****/
CREATE TABLE yam_index_product(
...
/****首页轮播广告商品表****/
INSERT INTO yam_index_carousel VALUES
(null,"myProject/image/ys-170801-ATF1500x300-baijiu-dvc._CB519794908_.jpg","新品Kindle<br>网页版"),
(null,"myProject/image/zh-20170420-1500300._CB510898404_.jpg","高端书写<br>专场" ),
(null,"myProject/image/xq-170802-1500300-book1._V519155710_.jpg","819畅销图书<br>店庆狂欢"),
(null,"myProject/image/dazhan_2017-08-07T09-41_100211_zd_170807_1500300_wine1._CB519728284_.jpg","819店庆全站狂欢酒畅销日"),
(null,"myProject/image/BOOKS_B100G40_ATF_1500300_1._CB504097682_.jpg","5万畅销<br>好书"),
(null,"myProject/image/1500300-819kv1-final._CB519094616_.jpg","819店庆购大<br>牌抢爆款"),
(null,"myProject/image/zd_170906_1500300_wine._V515899900_.jpg","中秋好礼<br> 醉心诗书"),
(null,"myProject/image/100-20-ATF._CB516137563_.jpg","九月开学礼满100元减20元");
